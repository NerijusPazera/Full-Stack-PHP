...
abstract class Router
{
     ...
     * @return mixed
     */
    abstract public static function add(string $name, string $url, string $controller_name, string $controller_method): void;
     ...
     * @return string|null
     */
    abstract protected static function getUrl($name): ?string;
